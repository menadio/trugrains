...
@section('content')
    <main class="px-4 lg:px-[100px] py-[120px] bg-purple">
        {{-- products details --}}
        <section class="lg:flex lg:flex-row lg:gap-4">
            {{-- details --}}
            <div class="text-white col-span-3">
                <div class="mb-20">
                    <h2 class="font-wagner font-bold text-4xl lg:text-[72px]">Sweet Potatoe cereal</h2>
            ...
            {{-- image --}}
            <div>
                <img src="{{ asset('images/png/sweetpotatoe_2x.png') }}" class="lg:max-w-md">
            </div>
