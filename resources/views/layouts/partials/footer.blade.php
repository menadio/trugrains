{{-- follow us --}}
<section class="px-4 py-[35px] flex justify-around bg-green text-white">
    <div class="flex items-center">
        <h4 class="mr-4 font-sora font-medium text-base md:text-2xl">FOLLOW US @TRUGRAINS</h4>
...
<footer class="pt-[120px] pb-[60px] bg-lime">
    ...
    <div class="mb-[30px] md:mx-[102px] px-4 lg:flex items-end">
        <div class="w-full lg:w-1/2">
            <h2 class="mb-6 font-wagner font-bold text-black text-4xl lg:text-[86px]">Stay Tru</h2>
            <p class="mb-[30px] font-sora text-black text-[21px]">Fresh Updates, <br>Direct to Your Inbox</p>
            <form action="">
                <input type="email" placeholder="Enter Your Email"
                    class="py-[18px] bg-lime border-black border-b-2 font-sora text-base w-full">
            </form>
        </div>

        <div class="w-full lg:w-1/2 lg:pl-4 mt-4 md:mt-4">
            <h4 class="mb-4 font-wagner font-bold text-2xl text-black">Follow Us: <br>@Trugrains</h4>
            <div class="mb-4 lg:mb-[60px] md:flex gap-8">
                ...
                <div class="hidden flex items-center font-sora font-medium text-base text-black">
                    <img src="{{ asset('images/png/instagram.png') }}" alt="" srcset="" class="mr-2">
                    Facebook
                </div>
            </div>
...
{{--                    <li>Privacy Policy</li>--}}
    ...
    <div class="mx-[102px] font-sora text-gray text-xs md:text-sm text-center">
